...
module.exports = class Holepuncher {
  ...
  _onholepunchmessage(_, addr, ref) {
    if (!this._diagnosedMessage) {
      this._diagnosedMessage = true
      diagnostic(this.isInitiator ? 'client' : 'server', 'udp-holepunch-message', {
        address: addr,
        initiator: this.isInitiator,
        punchingBefore: this.punching,
        connectedBefore: this.connected,
        remoteHolepunching: this.remoteHolepunching,
        localFirewall: this.nat.firewall,
        remoteFirewall: this.remoteFirewall
      })
    }
