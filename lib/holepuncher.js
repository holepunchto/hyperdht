...
module.exports = class Holepuncher {
  ...
  _onholepunchmessage (_, addr, ref) {
    if (!this.handshake.isInitiator) { // TODO: we don't need this if we had a way to connect a socket to many hosts
      holepunch(this._holder.socket, addr, false) // never fails
      return
    }
