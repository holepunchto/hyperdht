...
exports.authenticatedPHTNodeSignable = {
  preencode(state, m) {
    c.buffer.preencode(state, m.topologyID)
    c.json.preencode(state, m.phtNode)
  },
  encode(state, m) {
    c.buffer.encode(state, m.topologyID)
    c.json.encode(state, m.phtNode)
  },
  decode(state, m) {
    return {
      topologyID: c.buffer.decode(state),
      node: c.json.decode(state)
    }
  }
}

exports.authenticatedPHTNodePutRequest = {
  preencode(state, m) {
    c.fixed32.preencode(state, m.publicKey)
    c.buffer.preencode(state, m.topologyID)
    c.json.preencode(state, m.phtNode)
...
exports.authenticatedPHTNodeGetResponse = {
  preencode(state, m) {
    c.fixed32.preencode(state, m.publicKey)
    c.buffer.preencode(state, m.topologyID)
    c.json.preencode(state, m.phtNode)
...
exports.phtShardGetResponse = {
  preencode(state, m) {
    c.json.preencode(state, m.records)
  },
  encode(state, m) {
    c.json.encode(state, m.records)
  },
  decode(state) {
    return {
      records: c.json.decode(state)
    }
  }
}