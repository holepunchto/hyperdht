...
module.exports = class Server extends EventEmitter {
  ...
  async _addHandshake (k, noise, peerAddress, req) {
    ...
    const firewall = this.dht.firewalled ? FIREWALL.UNKNOWN : FIREWALL.OPEN
    ...
    if (pair.connect(remotePayload.addresses, peerAddress, req.to)) {
      return hs
    }
