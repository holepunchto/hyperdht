...
module.exports = class Server extends EventEmitter {
  ...
  _relayConnection(hs, relayThrough, remotePayload, h) {
    ...
    // Use RTT-based timeout for relay (default 15s)
    const relayTimeout = this.dht.getRTTBasedTimeout ? this.dht.getRTTBasedTimeout(15000) : 15000
    hs.relayTimeout = setTimeout(onabort, relayTimeout)
