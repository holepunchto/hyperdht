...
module.exports = class Server extends EventEmitter {
  ...
  onconnection (encryptedSocket) {
    this.tracer.trace('stream-open', encryptedSocket)
  ...
  async listen (keyPair = this.dht.defaultKeyPair, opts = {}) {
    ...
    this.tracer.trace('listen', keyPair.publicKey)
    this._listening = this._listen(keyPair, opts)
    await this._listening
    this.tracer.trace('listening', this.publicKey)
    return this
  }
