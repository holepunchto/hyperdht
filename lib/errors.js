module.exports = class DHTError extends Error {
  ...
  static HOLEPUNCH_RANDOMIZED_NATS (msg = 'Both remote and local NATs are randomized') {
    return new DHTError(msg, 'HOLEPUNCH_RANDOMIZED_NATS', DHTError.HOLEPUNCH_RANDOMIZED_NATS)
  }
