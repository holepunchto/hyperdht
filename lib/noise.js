...
module.exports = class NoiseState {
  ...
  static ed25519toCurve25519 (edKeys) {
    ...
    sodium.crypto_sign_ed25519_pk_to_curve25519(curveKeys.publicKey, edKeys.publicKey)
    sodium.crypto_sign_ed25519_sk_to_curve25519(curveKeys.secretKey, edKeys.secretKey)
    return curveKeys
  }
